...
The ``splinekit`` library focuses on uniform polynomial splines of nonnegative integer degree. These splines are real functions that map the domain :math:`{\mathbb{R}}` onto the image :math:`{\mathbb{R}}.`
